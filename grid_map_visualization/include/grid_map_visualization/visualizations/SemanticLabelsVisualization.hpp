 ...
 */
class SemanticLabelsVisualization : public VisualizationBase
{
 public:
   ...
   */
  SemanticLabelsVisualization(ros::NodeHandle& nodeHandle, const std::string& name);

  /*!
   * Destructor.
   */
  virtual ~SemanticLabelsVisualization();
